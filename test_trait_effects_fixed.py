...
def test_healing_with_traits():
    ...
    creator.choose_background("wasteland_doctor")  # ✅ 修复：添加背景选择
...
def test_perception_modifier():
    ...
    creator1.choose_background("scavenger")  # ✅ 修复：添加背景选择
    ...
    creator2.choose_background("scavenger")  # ✅ 修复：添加背景选择
    ...
    creator3.choose_background("scavenger")  # ✅ 修复：添加背景选择
...
def test_agility_modifier():
    ...
    creator.choose_background("scavenger")  # ✅ 修复：添加背景选择
